...
void loop() {
  // pone los leds en el mismo valor del botón
  digitalWrite(LED1, digitalRead(BOTON));
  digitalWrite(LED2, digitalRead(BOTON));
  digitalWrite(LED3, digitalRead(BOTON));
  digitalWrite(LED4, digitalRead(BOTON));
}
